...
const START = {} as Record<SceneName, number>;
const LEN = {} as Record<SceneName, number>;
let acc = 0;
    ...
    <Scene>
      ...
      <div style={{ position: "absolute", left: 0, right: 0, top: 290, display: "flex", flexDirection: "column", alignItems: "center" }}>
        <Card width={1150} videoW={1476} videoH={864} delay={6}>
          <Sequence durationInFrames={LEN.themes} layout="none">
  ...
  <Scene>
    ...
    <div style={{ position: "absolute", left: 110, top: 420 }}>
      <Card width={640} videoW={1536} videoH={948} inset={24} delay={6} rotate={-4}>
        <Sequence durationInFrames={LEN.tuis} layout="none">
...
const Agents: React.FC = () => {
  const a = useSpring(0);
  const b = useSpring(60);
  return (
    <Scene>
      <Index n={10} />
      <AbsoluteFill style={{ justifyContent: "center", padding: "0 160px", gap: 90 }}>
        <div style={{ opacity: a, transform: `translateY(${(1 - a) * 30}px)` }}>
          <div style={{ fontFamily: MONO, fontSize: 30, color: MUTED, marginBottom: 18 }}>No script? Record a live session — it writes the script for you.</div>
          <Typed text="tcut rec -- lazygit" from={6} cps={1.4} size={60} />
        </div>
        <div style={{ opacity: b, transform: `translateY(${(1 - b) * 30}px)` }}>
          <div style={{ fontFamily: MONO, fontSize: 30, color: MUTED, marginBottom: 18 }}>Using Claude Code, Codex or Cursor? Your agent already knows tcut.</div>
          <Typed text="npx skills add AmanVarshney01/tcut" from={66} cps={1.6} size={60} color={AMBER} />
        </div>
      </AbsoluteFill>
    </Scene>
  );
...
const S: React.FC<{ name: SceneName; children: React.ReactNode }> = ({ name, children }) => (
  <Sequence from={START[name]} durationInFrames={LEN[name]}>
    {children}
  </Sequence>
);
      ...
      <Split
        ...
        card={
          <Card width={1060} videoW={1258} videoH={852} inset={24} delay={6}>
            <Sequence durationInFrames={LEN.browser} layout="none">
      ...
      <Split
        ...
        card={
          <Card width={1060} videoW={1280} videoH={720} inset={24} delay={6}>
            <Sequence durationInFrames={LEN.claude} layout="none">
      ...
      <Split
        ...
        card={
          <Card width={1000} videoW={1056} videoH={708} inset={24} delay={6}>
            <Sequence durationInFrames={LEN.captions} layout="none">
      ...
      <Split
        ...
        card={
          <Card width={1060} videoW={1280} videoH={756} inset={24} delay={6}>
            <Sequence durationInFrames={LEN.zoom} layout="none">
      ...
      <Split
        ...
        card={
          <Card width={1060} videoW={1548} videoH={864} delay={6}>
            <Sequence durationInFrames={LEN.ci} layout="none">
